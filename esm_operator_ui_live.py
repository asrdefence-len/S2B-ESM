...
class LiveS2BOperatorWindow(EnhancedS2BOperatorWindow):
    ...
    def _new_stream(self):
        ...
        self.stream_source=SimulatedStreamingIQSource(sample_rate_hz=40_000_000,center_frequency_hz=9_400_000_000,block_samples=self.BLOCK_SAMPLES,noise_std=.02)
